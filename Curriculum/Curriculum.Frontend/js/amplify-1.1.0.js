...
// http://msdn.microsoft.com/en-us/library/ms531424(v=vs.85).aspx
    (function() {
        ...
        store.addType("userData", function(key, value, options) {
            ...
            key = key.replace(new RegExp("[^-._0-9A-Za-z\\xb7\\xc0-\\xd6\\xd8-\\xf6\\xf8-\\u037d\\u37f-\\u1fff\\u200c-\\u200d\\u203f\\u2040\\u2070-\\u218f]", "g"), "-");
...
(function(amplify, $, undefined) {
    ...
    amplify.request.types.ajax = function(defnSettings) {
        ...
        return function(settings, request) {
            ...
            $.extend(ajaxSettings, {
                success: function(data, status) {
                    handleResponse(data, status, this);
                },
                error: function(_xhr, status) {

                    handleResponse(null, status, this);
                },
            ...
            function handleResponse(data, status, settings) {
...
//			}
                ...
                if (/timeout|error|abort/.test(status)) {
                    ampXHR.error(data, status, settings);
                } else {
    ...
    amplify.subscribe("request.before.ajax", function(resource, settings, ajaxSettings, ampXHR) {
        ...
        ampXHR.error = function(data, status, settings) {
            decoder(data, status, ampXHR, success, error, settings);
        };
    });
}(amplify, jQuery));