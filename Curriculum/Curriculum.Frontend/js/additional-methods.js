...
jQuery.validator.addMethod("skip_or_fill_minimum", function(value, element, options) {
    var $fields = jQuery(options[1], element.form),
        $fieldsFirst = $fields.eq(0),
        validator = $fieldsFirst.data("valid_skip") ? $fieldsFirst.data("valid_skip") : jQuery.extend({}, this),
...
jQuery.validator.addMethod("greaterOrEqualThanIgnoreNulls",
    function(value, element, params) {
        if (!value || !jQuery(params).val()) {
            return true;
        }
...
jQuery.validator.addMethod("dateGreaterOrEqualThan", function(value, element, params) {

    if (!/Invalid|NaN/.test(new Date(moment(value, "L").toString()))) {
        return new Date(moment(value, "L").toString()) >= new Date(moment(jQuery(params).val(), "L"));
    }
...
jQuery.validator.addMethod("dateGreaterOrEqualThanIgnoreNulls", function(value, element, params) {
...
jQuery.validator.addMethod("validDate",
    function(value, element, params) {
        ...
        return moment(value, ["L", "YYYY-MM-DD"], true).isValid();
    }, "Must be greater or Equal than {0}.");